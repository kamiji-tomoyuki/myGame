...
public:
	...
	/// <param name="rotationY">現在のY軸回転（rad）</param>
	/// <param name="outNewPos">前進後の座標（出力）</param>
...
public:
	...
	bool IsFinisherAdvancing() const { return isFinisherAdvancing_; }
...
private:
	...
	static constexpr float kFinisherMaxAdvance_ = 4.0f;
};